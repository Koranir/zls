    ...
    pub fn resolveType(self: DeclWithHandle, analyser: *Analyser) !?TypeWithHandle {
        ...
        return switch (self.decl.*) {
            ...
            .intern_pool_index => |payload| {
                ...
                return TypeWithHandle{
                    .type = .{
                        .data = .{ .intern_pool_index = .{ .node = 0, .index = payload.index } },
                        .is_type_val = false,
                    },
                    .handle = self.handle,
                };
...
pub fn lookupDeclaration(document_scope: DocumentScope, symbol: Declaration.Key, source_index: usize) ?Declaration.Index {
